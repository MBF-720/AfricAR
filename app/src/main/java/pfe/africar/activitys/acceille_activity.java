...
import pfe.africar.R;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		_bg__tabler_search_ek1 = (View) findViewById(R.id._bg__tabler_search_ek1);
		vector_ek17 = (ImageView) findViewById(R.id.vector_ek17);
		_bg__mingcute_settings_6_fill_ek1 = (View) findViewById(R.id._bg__mingcute_settings_6_fill_ek1);
		...
		_bg__frame_53_ek1 = (View) findViewById(R.id._bg__frame_53_ek1);
		_bg__frame_10_ek7 = (View) findViewById(R.id._bg__frame_10_ek7);
		_bg__frame_8_ek9 = (View) findViewById(R.id._bg__frame_8_ek9);
		_bg__frame_1_ek3 = (View) findViewById(R.id._bg__frame_1_ek3);
		assignments = (TextView) findViewById(R.id.assignments);
		history_essay_due_friday__april_5th__make_sure_to_include_citations_ = (TextView) findViewById(R.id.history_essay_due_friday__april_5th__make_sure_to_include_citations_);
		_10_40_am = (TextView) findViewById(R.id._10_40_am);
		_bg__frame_9_ek7 = (View) findViewById(R.id._bg__frame_9_ek7);
		...
		_bg__frame_11_ek7 = (View) findViewById(R.id._bg__frame_11_ek7);
		_bg__frame_8_ek11 = (View) findViewById(R.id._bg__frame_8_ek11);
		_bg__frame_1_ek5 = (View) findViewById(R.id._bg__frame_1_ek5);
		activities = (TextView) findViewById(R.id.activities);
		history_essay_due_friday__april_5th__make_sure_to_include_citations__ek1 = (TextView) findViewById(R.id.history_essay_due_friday__april_5th__make_sure_to_include_citations__ek1);
		_10_40_am_ek1 = (TextView) findViewById(R.id._10_40_am_ek1);
		_bg__frame_9_ek9 = (View) findViewById(R.id._bg__frame_9_ek9);
		ellipse_25_ek1 = (View) findViewById(R.id.ellipse_25_ek1);
		ellipse_26_ek1 = (View) findViewById(R.id.ellipse_26_ek1);
		ellipse_27_ek1 = (View) findViewById(R.id.ellipse_27_ek1);
		_bg__frame_12_ek7 = (View) findViewById(R.id._bg__frame_12_ek7);
		_bg__frame_8_ek13 = (View) findViewById(R.id._bg__frame_8_ek13);
		_bg__frame_1_ek7 = (View) findViewById(R.id._bg__frame_1_ek7);
		events = (TextView) findViewById(R.id.events);
		history_essay_due_friday__april_5th__make_sure_to_include_citations__ek2 = (TextView) findViewById(R.id.history_essay_due_friday__april_5th__make_sure_to_include_citations__ek2);
		_10_40_am_ek2 = (TextView) findViewById(R.id._10_40_am_ek2);
		_bg__frame_9_ek11 = (View) findViewById(R.id._bg__frame_9_ek11);
		ellipse_25_ek2 = (View) findViewById(R.id.ellipse_25_ek2);
		ellipse_26_ek2 = (View) findViewById(R.id.ellipse_26_ek2);
		ellipse_27_ek2 = (View) findViewById(R.id.ellipse_27_ek2);
		_bg__frame_13_ek7 = (View) findViewById(R.id._bg__frame_13_ek7);
		_bg__frame_8_ek15 = (View) findViewById(R.id._bg__frame_8_ek15);
		_bg__frame_1_ek9 = (View) findViewById(R.id._bg__frame_1_ek9);
		opportunities = (TextView) findViewById(R.id.opportunities);
		history_essay_due_friday__april_5th__make_sure_to_include_citations__ek3 = (TextView) findViewById(R.id.history_essay_due_friday__april_5th__make_sure_to_include_citations__ek3);
		_10_40_am_ek3 = (TextView) findViewById(R.id._10_40_am_ek3);
		_bg__frame_9_ek13 = (View) findViewById(R.id._bg__frame_9_ek13);
		ellipse_25_ek3 = (View) findViewById(R.id.ellipse_25_ek3);
		ellipse_26_ek3 = (View) findViewById(R.id.ellipse_26_ek3);
		ellipse_27_ek3 = (View) findViewById(R.id.ellipse_27_ek3);
		...
		_bg__mingcute_notification_fill_ek1 = (View) findViewById(R.id._bg__mingcute_notification_fill_ek1);
		...
		_bg__component_2_ek9 = (View) findViewById(R.id._bg__component_2_ek9);
