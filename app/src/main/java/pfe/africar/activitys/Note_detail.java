                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                Toast.makeText(Note_detail.this, "Document does not exist", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(Note_detail.this, "Error getting document: " + task.getException(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        if (nom != null && prenom != null) {
                            ...
                            Toast.makeText(Note_detail.this, "Nom or prenom field is empty.", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(Note_detail.this, "No such document.", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(Note_detail.this, "Failed to get document: " + task.getException(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
